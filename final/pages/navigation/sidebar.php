<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="../../index.php" class="site_title"><img src="../../Images/logo.png" style="width: 100%; height: 100%"></img></a>
        </div>
								...
								if ($_SESSION['role'] == 'Admin') { ?>
                                    ...
                                    <li><a><i class='fa fa-edit'></i> Users <span class='fa fa-chevron-down'></span></a>
                                        <ul class='nav child_menu'>
                                            <li><a href='../users/admins/manage-users.php'>Manage Users</a></li>
                                            <li><a href='../users/admins/manage-suspended.php'>Suspended</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a><i class='fa fa-edit'></i> Listings <span class='fa fa-chevron-down'></span></a>
                                        <ul class='nav child_menu'>
                                            <li><a href='../listings/create.php'>New Listing</a></li>
                                            <li><a href='../listings/all.php'><?php echo $listings; ?></a></li>
                                            <li><a href='../listings/history.php'>Manage My Listings</a></li>
                                        </ul>
                                    </li>
