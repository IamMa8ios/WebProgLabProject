<?php
							...
							<tr class='odd pointer'>
                                ...
                                <td class='last'>
                                    <form action="pages-user-listings-manage.php" method="post">
                                        <button type="submit" name="view_button" value="<?php echo $row['id']; ?>" class="btn btn-primary"><span class="glyphicon glyphicon-eye-open" ></span> View</button>
                                        <?php if($_SESSION['role']==$owner || ($_SESSION['role']=='Admin' && $owner=='Admin')){ ?>
                                        <?php if($row['status']=='Open'){ ?>
                                            <button type="submit" name="disable_button" value="<?php echo $row['id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-remove" ></span> Disable</button>
										<?php }elseif($row['status']=='Closed'){ ?>
                                            <button type="submit" name="enable_button" value="<?php echo $row['id']; ?>" class="btn btn-success"><span class="glyphicon glyphicon-ok" ></span> Enable</button>
										<?php } ?>
                                    </form>
                                </td>
							</tr>
	...
	function loadProfile($userID){
		...
		if ($mysqli) {
			...
			$sql = "SELECT `name`, `birthday`, `phone`, `country`, `email`, `job`, `website`
                    FROM `profiles`
                    WHERE `userID`=?";
